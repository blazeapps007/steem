...
fc::variant_object get_config()
{
   ...
   result["STEEM_CONTENT_CONSTANT_HF21"] = STEEM_CONTENT_CONSTANT_HF21;
   ...
   result["STEEM_BRIDGE_ORACLE_MIN_CONFIRMATIONS"] = STEEM_BRIDGE_ORACLE_MIN_CONFIRMATIONS;
   result["STEEM_BRIDGE_ORACLE_LIFETIME_BLOCKS"] = STEEM_BRIDGE_ORACLE_LIFETIME_BLOCKS;
   result["STEEM_BRIDGE_ORACLE_MAX_CANDIDATES"] = STEEM_BRIDGE_ORACLE_MAX_CANDIDATES;
   result["STEEM_BRIDGE_ORACLE_MATURITY_BLOCKS"] = STEEM_BRIDGE_ORACLE_MATURITY_BLOCKS;
   result["STEEM_GENESIS_TIME"] = STEEM_GENESIS_TIME;
   result["STEEM_HARDFORK_REQUIRED_WITNESSES"] = STEEM_HARDFORK_REQUIRED_WITNESSES;
   result["STEEM_HF21_CONVERGENT_LINEAR_RECENT_CLAIMS"] = STEEM_HF21_CONVERGENT_LINEAR_RECENT_CLAIMS;
   ...
   result["STEEM_SBD_INIT_SUPPLY"] = STEEM_SBD_INIT_SUPPLY;
   ...
   result["STEEM_MIN_COMMENT_EDIT_INTERVAL"] = STEEM_MIN_COMMENT_EDIT_INTERVAL;
   ...
   result["STEEM_REVERSE_AUCTION_WINDOW_SECONDS_HF21"] = STEEM_REVERSE_AUCTION_WINDOW_SECONDS_HF21;
   ...
   result["STEEM_BRIDGE_BANK_ACCOUNT"] = STEEM_BRIDGE_BANK_ACCOUNT;
   ...
   result["STEEM_PROPOSAL_SUBJECT_MAX_LENGTH"] = STEEM_PROPOSAL_SUBJECT_MAX_LENGTH;
   result["STEEM_PROPOSAL_MAX_IDS_NUMBER"] = STEEM_PROPOSAL_MAX_IDS_NUMBER;
